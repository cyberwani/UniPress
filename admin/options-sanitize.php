...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'unipress' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'unipress' ),
		'repeat-y'  => __( 'Repeat Vertically', 'unipress' ),
		'repeat'    => __( 'Repeat All', 'unipress' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'unipress' ),
		'top center'    => __( 'Top Center', 'unipress' ),
		'top right'     => __( 'Top Right', 'unipress' ),
		'center left'   => __( 'Middle Left', 'unipress' ),
		'center center' => __( 'Middle Center', 'unipress' ),
		'center right'  => __( 'Middle Right', 'unipress' ),
		'bottom left'   => __( 'Bottom Left', 'unipress' ),
		'bottom center' => __( 'Bottom Center', 'unipress' ),
		'bottom right'  => __( 'Bottom Right', 'unipress')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'unipress' ),
		'fixed'  => __( 'Fixed in Place', 'unipress')
		);
